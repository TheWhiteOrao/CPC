...
if __name__ == '__main__':
    ...
    while True:
        ...
        print("QuaternionR: %-26s" % ((acos(Quaternion["QuaternionR"]) * 2) * 180 / pi),
              "QuaternionI: %-26s" % ((acos(Quaternion["QuaternionI"]) * 2) * 180 / pi),
              "QuaternionJ: %-26s" % ((acos(Quaternion["QuaternionJ"]) * 2) * 180 / pi),
              "QuaternionK: %-26s" % ((acos(Quaternion["QuaternionK"]) * 2) * 180 / pi))
